...
class PointWaveSource extends WaveSource {
  ...
  accumulateNormal (out : Float32Array, timestamp : number, xy : Float32Array) {
    var phase = this.getPhase(timestamp, xy)
